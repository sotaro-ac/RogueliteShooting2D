...
public class PanelGameOverController : MonoBehaviour
{
    // 背景
    [SerializeField]
    Image panelGameOverBG;

    // 生存時間、レベル、倒した敵
    [SerializeField]
    Text textSurvivedResult;

    [SerializeField]
    Text textLevelResult;

    [SerializeField]
    Text textEnemyResult;

    // 武器、レベル、ダメージ、時間、DPS
    [SerializeField]
    Text textWeaponNameTitle;

    [SerializeField]
    Text textWeaponLevelTitle;

    [SerializeField]
    Text textWeaponDamageTitle;

    [SerializeField]
    Text textWeaponTimeTitle;

    [SerializeField]
    Text textWeaponDPSTitle;
